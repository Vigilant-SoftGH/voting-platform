...
setName(query);
  ...
  _closed={{ animationName: "fade-out, scale-out", animationDuration: "120ms" }} zIndex="1" m={{base: "70px", md:"100px"}} rounded="md" bg="gray.500" lineHeight={1} w="60%" h="60%" py="10%" opacity="0.93">
